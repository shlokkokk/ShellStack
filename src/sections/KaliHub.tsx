                    ...
                    <div className="flex flex-wrap gap-1.5 mb-2">
                      {categoryTools.map((tool) => (
                        <button
                          ...
                          className="px-2 py-0.5 text-xs font-mono text-[#A7B0BC] bg-[#05060B] rounded border border-[rgba(243,245,249,0.08)] hover:border-[rgba(57,255,20,0.3)] hover:text-[#39FF14] transition-colors"
                        >
                          {tool.name}
                        </button>
                      ))}
