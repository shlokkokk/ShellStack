...
export const cehModules: Module[] = [
  {
    ...
    topics: [
      ...
      },
      {
        ...
        content: 'Adversaries are categorized not just by skill, but by their motivation, intent, and legality. The spectrum ranges from highly organized state-sponsored APTs to chaotic script kiddies.',
        keyPoints: [
      ...
      },
      {
        ...
        content: 'Professional penetration testing is not random; it is a highly structured, methodical process designed to emulate advanced adversaries comprehensively across five rigid phases.',
        keyPoints: [
          'Phase 1: Reconnaissance (Information Gathering) — Passive and active mapping of the attack surface',
          'Phase 2: Scanning — Aggressively probing the network for live hosts, open ports, and vulnerable services',
          'Phase 3: Gaining Access (Exploitation) — Weaponizing vulnerabilities to breach the target perimeter natively',
          'Phase 4: Maintaining Access — Deploying backdoors, C2 implants, and rootkits to ensure persistent control',
          'Phase 5: Clearing Tracks — Scrubbing logs, modifying timestamps, and deleting forensic evidence',
        ],
      },
      {
        id: 'm01-t05',
        title: 'Legal and Regulatory Framework',
        content: 'Ethical hacking outside the bounds of the law is a felony. Professionals must navigate complex international cyber laws and strict compliance mandates while operating under a bulletproof Rules of Engagement (RoE).',
        keyPoints: [
          ...
          'GDPR & HIPAA: Stringent international and healthcare privacy laws carrying massive financial penalties for breaches',
...
Proper footprinting builds the "Attack Surface Map"—identifying entry points, technology stacks, physical locations, human resources, and security postures. It involves two primary domains: Passive Information Gathering (where we never touch the target\'s servers directly, utilizing search engines and third-party databases) and Active Information Gathering (direct queries to the target\'s publicly facing infrastructure such as DNS servers).`,
  ...
  },
  {
    ...
    number: 'M04',
    title: 'Enumeration',
    description: 'Master advanced enumeration techniques to extract detailed environment signatures from target infrastructure. Learn to map network resources, user accounts, system shares, and service details using technical protocols like SNMP, LDAP, SMB, and NetBIOS.',
    examWeight: '7%',
  ...
  },
  {
    ...
    description: 'Develop a systematic approach to identifying, classifying, and prioritizing security weaknesses across diverse environments. Learn to utilize professional scanning frameworks, interpret CVSS scoring metrics, and navigate international vulnerability databases to build a robust risk profile.',
    examWeight: '7%',
    estimatedQuestions: 9,
    duration: '3h 30m',
    topics: [
  ...
  },
  {
    ...
    description: 'Execute complex system exploitation including advanced password cracking, Linux/Windows privilege escalation, and persistence mechanisms. Learn the art of operational stealth through track clearing and rootkit deployment while maintaining persistent access to compromised targets.',
    examWeight: '8%',
    estimatedQuestions: 10,
    duration: '5h 15m',
    topics: [
  ...
  },
  {
    ...
    description: 'Analyze the technical landscape of malicious software, from self-replicating worms to advanced ransomware and rootkits. Master the Advanced Persistent Threat (APT) lifecycle, static/dynamic malware analysis techniques, and the deployment of sandbox environments for threat intelligence.',
    examWeight: '6%',
    estimatedQuestions: 7,
    duration: '3h 45m',
    topics: [
  ...
  },
  {
    ...
    number: 'M08',
    title: 'Sniffing',
    description: 'Gain deep visibility into network traffic through passive and active sniffing techniques. Learn to weaponize protocols like ARP for man-in-the-middle (MITM) attacks, analyze unencrypted packet flows in Wireshark, and identify sensitive data leakage across the wire.',
    examWeight: '5%',
  ...
  },
  {
    ...
    description: 'Master the psychological art of human manipulation to bypass technical security controls. Explore advanced social engineering vectors including spear-phishing, whaling, vishing, and physical tailgating while leveraging frameworks like SET for automated social manipulation.',
    examWeight: '5%',
    estimatedQuestions: 6,
    duration: '3h 30m',
    topics: [
  ...
  },
  {
    ...
    description: 'Explore the architecture of disruption through Denial of Service (DoS) and Distributed Denial of Service (DDoS) attacks. Master volumetric, protocol-based, and application-layer attack vectors, botnet orchestration, and professional mitigation strategies for high-availability environments.',
    examWeight: '4%',
  ...
  },
  {
    ...
    description: 'Learn to intercept and hijack active user sessions by weaponizing session token vulnerabilities. Explore techniques for session sniffing, fixation, and prediction while mastering the countermeasures required to secure modern web authentication flows.',
    examWeight: '4%',
    estimatedQuestions: 5,
    duration: '2h 30m',
    topics: [
  ...
  },
  {
    ...
    description: 'Master the technical art of bypassing enterprise security controls including Intrusion Detection Systems (IDS), firewalls, and decoy honeypots. Learn advanced evasion techniques like packet fragmentation, source port spoofing, and timing manipulation to stay undetected.',
    examWeight: '5%',
    estimatedQuestions: 6,
    duration: '3h 00m',
    topics: [
  ...
  },
  {
    ...
    description: 'Analyze the attack surface of web server infrastructure, focusing on misconfigurations, directory traversal, and server-side vulnerabilities. Learn to perform banner grabbing, HTTP method interrogation, and server-side request forgery (SSRF) to compromise hosting environments.',
    examWeight: '5%',
    estimatedQuestions: 6,
    duration: '3h 15m',
    topics: [
  ...
  },
  {
    ...
    description: 'Deep dive into the OWASP Top 10 vulnerabilities and modern web application exploitation. Master complex attack vectors including Cross-Site Scripting (XSS), Cross-Site Request Forgery (CSRF), and insecure file uploads while implementing professional remediation strategies.',
    examWeight: '7%',
    estimatedQuestions: 9,
    duration: '4h 30m',
    topics: [
  ...
  },
  {
    ...
    number: 'M15',
    title: 'SQL Injection',
    description: 'Master the devastating power of SQL injection to exfiltrate data and compromise backend databases. Explore manual injection techniques, automated exploitation with SQLmap, and advanced Web Application Firewall (WAF) bypass strategies for hardened environments.',
    examWeight: '6%',
    estimatedQuestions: 7,
    duration: '4h 00m',
    topics: [
  ...
  },
  {
    ...
    description: 'Explore the technical vulnerabilities of wireless communication, from WEP and WPA2 to the latest WPA3 standards. Master hands-on techniques for handshake capture, deauthentication attacks, evil twin deployment, and WPS PIN brute-forcing.',
    examWeight: '5%',
    estimatedQuestions: 6,
    duration: '3h 30m',
    topics: [
  ...
  },
  {
    ...
    description: 'Analyze the security architecture of modern mobile platforms including Android and iOS. Learn to perform application decompilation, sandbox analysis, and device exploitation while identifying the unique threats posed by mobile-specific attack surfaces.',
    examWeight: '4%',
    estimatedQuestions: 5,
    duration: '3h 00m',
    topics: [
  ...
  },
  {
    ...
    description: 'Deep dive into the rapidly expanding landscape of Internet of Things (IoT) and Operational Technology (OT) security. Explore specialized protocols, hardware hacking techniques, and the critical vulnerabilities found in industrial control systems and smart devices.',
    examWeight: '3%',
  ...
  },
  {
    ...
    description: 'Master the security challenges of cloud-native environments including AWS, Azure, and Google Cloud. Explore container security, serverless vulnerabilities, and identity management flaws while learning to navigate the shared responsibility model.',
    examWeight: '4%',
    estimatedQuestions: 5,
    duration: '3h 00m',
    topics: [
  ...
  },
  {
    ...
    number: 'M20',
    title: 'Cryptography',
    description: 'Master the mathematical foundation of data security through modern cryptography. Explore symmetric/asymmetric encryption algorithms, Public Key Infrastructure (PKI), digital signatures, and the technical methods used in cryptanalysis and breaking weak encryption.',
    examWeight: '5%',
    estimatedQuestions: 6,
    duration: '3h 30m',
    topics: [
