...
export const easterEggs: Record<string, OutputLine[]> = {
  'sudo rm -rf /': [
    ...
    { text: '', delay: 300 },
    { text: '[!] Nice try. Permission denied.', color: 'red' },
  ...
  'exit': [
    ...
    { text: 'You are here forever. [x_x]', color: 'dim' },
    { text: '', color: 'dim' },
  ],
  'sudo su': [
    { text: '[sudo] password for kali: ********', color: 'white', delay: 400 },
    { text: '', delay: 300 },
    { text: "You are already root in ShellStack. [CROWN]", color: 'green' },
    { text: '', color: 'dim' },
  ],
  'rm -rf /': [
  ...
  'sudo make me a sandwich': [
    { text: "Okay. [sandwich]", color: 'green' },
    { text: '', color: 'dim' },
  ],
  'hello': [
  ...
  'hi': [
    { text: 'Hey there, hacker. [B)]', color: 'cyan' },
    { text: '', color: 'dim' },
  ],
  ':(){ :|:& };:': [
    { text: '[SYSTEM] Fork bomb detected and neutralized.', color: 'red', delay: 300 },
    { text: '[SYSTEM] Nice try with the classic fork bomb. ShellStack is hardened. [SHIELD]', color: 'yellow' },
    { text: '', color: 'dim' },
  ],
  'sl': [
    ...
    { text: '', delay: 100 },
    { text: '[SL] Choo choo! You typed sl instead of ls.', color: 'yellow' },
    { text: '', color: 'dim' },
  ],
};
