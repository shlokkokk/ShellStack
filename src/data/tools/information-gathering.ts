...
export const informationGatheringTools: Tool[] = [
  ...
  },
  {
    id: 'theharvester',
    name: 'theHarvester',
    description: 'An indispensable passive OSINT reconnaissance tool that harvests emails, names, subdomains, IPs, URLs, and exposed services from 30+ public data sources including Google, Bing, LinkedIn, Shodan, Censys, GitHub, Hunter.io, and more. A de-facto standard for early-stage intelligence gathering that never touches the target directly.',
    category: 'information-gathering',
    difficulty: 'beginner',
    tags: ['osint', 'recon', 'passive', 'emails', 'subdomains', 'employee-enumeration', 'must-know'],
    commands: [
      { command: 'theHarvester -d example.com -b all', description: 'Search all available sources for emails, subdomains, and hosts' },
      { command: 'theHarvester -d example.com -b google,bing,linkedin', description: 'Use specific search engines and social sources' },
      { command: 'theHarvester -d example.com -b google -l 500', description: 'Search Google and limit to 500 results' },
      { command: 'theHarvester -d example.com -b linkedin', description: 'Search LinkedIn for employee names tied to the target company' },
      { command: 'theHarvester -d example.com -b shodan', description: 'Query Shodan for exposed services and host intelligence' },
      { command: 'theHarvester -d example.com -b github', description: 'Search GitHub for leaked credentials, domains, or references' },
      { command: 'theHarvester -d example.com -b hunter -l 100', description: 'Use Hunter.io to identify verified business email addresses' },
      { command: 'theHarvester -d example.com -b google,bing,linkedin -f output', description: 'Use multiple sources and save output files (XML/JSON)' },
      { command: 'theHarvester -d example.com -b all -f results.html', description: 'Run broad collection and save output for reporting' },
    ],
    whenToUse: [
      'At the very beginning of an engagement to passively collect emails and subdomains',
      'During OSINT reconnaissance to map external assets without touching target servers',
      'To discover employee names and business email patterns for phishing simulation scope',
      'To identify infrastructure clues (IPs, hosts, exposed services) from passive sources',
      'To build target lists for follow-on recon and validation with tools like Amass or Nmap',
    ],
    commonFlags: [
      { flag: '-d', description: 'Target domain or company name' },
      { flag: '-b', description: 'Data source(s) to query (google, bing, linkedin, shodan, hunter, all)' },
      { flag: '-l', description: 'Limit number of results' },
      { flag: '-f', description: 'Save output files (XML and JSON)' },
